...
⚡ Electronics Engineer and technology entrepreneur, specializing in the intersection of hardware (IoT, embedded systems) and Artificial Intelligence.
💻 With versatile proficiency in multiple programming languages ​​(Python, C, C++, C#, and JavaScript), I leverage leading AI frameworks, web ecosystems, and game engines to bring complex ideas to life.
🚀 I lead the creation and comprehensive management of disruptive products, from full-stack development and machine learning architectures to the design of immersive experiences (VR/AR).
🤝 I work collaboratively within horizontal structures, applying agile methodologies, innovation, and rigorous research to solve real-world problems.
🌍 My primary motivation is clear: to catalyze profound social transformation, revolutionizing different sectors through a synergy between technological development and a deep Christian humanism, always putting innovation at the service of people.
...
![Neural Networks](https://img.shields.io/badge/Neural%20Networks-FF6F00?style=for-the-badge&logo=google-cloud&logoColor=white)
...
![NLP](https://img.shields.io/badge/NLP-43853D?style=for-the-badge&logo=target&logoColor=white)
